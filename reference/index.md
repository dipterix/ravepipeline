...
- [`base64_urlencode()`](http://dipterix.org/ravepipeline/reference/base64-utils.md)
  [`base64_encode()`](http://dipterix.org/ravepipeline/reference/base64-utils.md)
  [`base64_urldecode()`](http://dipterix.org/ravepipeline/reference/base64-utils.md)
  [`base64_decode()`](http://dipterix.org/ravepipeline/reference/base64-utils.md)
...
- [`mcpflow_export()`](http://dipterix.org/ravepipeline/reference/mcpflow_export.md)
...
- [`mcpflow_list()`](http://dipterix.org/ravepipeline/reference/mcpflow_list.md)
  : List RAVE MCP workflow names

- [`mcpflow_load_all()`](http://dipterix.org/ravepipeline/reference/mcpflow_load_all.md)
  : Load RAVE MCP workflows

- [`mcpflow_path()`](http://dipterix.org/ravepipeline/reference/mcpflow_path.md)
...
- [`mcpflow_tool_names()`](http://dipterix.org/ravepipeline/reference/mcpflow_tool_names.md)
  : Extract tool names from workflows

- [`mcpflow_tools()`](http://dipterix.org/ravepipeline/reference/mcpflow_tools.md)
  : Load Tools for Workflow

- [`mcpflow_validate()`](http://dipterix.org/ravepipeline/reference/mcpflow_validate.md)
  : Validate RAVE MCP workflow

- [`mcpflow_write()`](http://dipterix.org/ravepipeline/reference/mcpflow_write.md)
  : Write RAVE MCP workflow to a file

- [`mcptool_build()`](http://dipterix.org/ravepipeline/reference/mcptool_build.md)
...
- [`mcptool_list()`](http://dipterix.org/ravepipeline/reference/mcptool_list.md)
...
- [`mcptool_path()`](http://dipterix.org/ravepipeline/reference/mcptool_path.md)
...
- [`mcptool_write()`](http://dipterix.org/ravepipeline/reference/mcptool_write.md)
...
- [`rave_serialize_refhook()`](http://dipterix.org/ravepipeline/reference/rave-serialize-refhook.md)
  [`rave_serialize_impl()`](http://dipterix.org/ravepipeline/reference/rave-serialize-refhook.md)
  [`rave_unserialize_refhook()`](http://dipterix.org/ravepipeline/reference/rave-serialize-refhook.md)
  [`rave_unserialize_impl()`](http://dipterix.org/ravepipeline/reference/rave-serialize-refhook.md)
...
- [`load_yaml()`](http://dipterix.org/ravepipeline/reference/read-write-yaml.md)
  [`save_yaml()`](http://dipterix.org/ravepipeline/reference/read-write-yaml.md)
  :

  Read write `'YAML'` format

- [`with_rave_parallel()`](http://dipterix.org/ravepipeline/reference/with_rave_parallel.md)
  [`lapply_jobs()`](http://dipterix.org/ravepipeline/reference/with_rave_parallel.md)
