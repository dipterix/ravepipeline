...
#> [1] "ravepipeline-mcp_get_current_rave_pipeline_info"    
#> [2] "ravepipeline-mcp_get_current_rave_pipeline_progress"
#> [3] "ravepipeline-mcp_list_rave_pipelines"               
#> [4] "ravepipeline-mcp_load_rave_pipeline"                
#> [5] "ravepipeline-mcp_read_current_rave_pipeline_results"
#> [6] "ravepipeline-mcp_run_current_rave_pipeline"         
#> [7] "ravepipeline-mcp_set_current_rave_pipeline_settings"
#> [8] "ravepipeline-mcpflow_load_all"                      
