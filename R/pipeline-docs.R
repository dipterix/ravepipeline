...
#' 'RAVE' website.
#' @param pipe_dir where the pipeline directory is; can be set via
...
#' @param subject character indicating valid 'RAVE' subject ID, or a
#' \code{RAVESubject} instance
    ...
    targets::tar_target_raw(
      ...
      command = quote({
        ...
        tryCatch({
          ...
          asNamespace("ravepipeline")$resolve_pipeline_error(
